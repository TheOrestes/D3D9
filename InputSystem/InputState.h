...
enum InputState
{
	 MOUSE_LEFTCLICK,				// Do Not move this position
 	 MOUSE_RIGHTCLICK,				// Mouse is included first to map clicks
	 MOUSE_MIDDLECLICK,				// with InputState enum.
	 KEY_W,
	 KEY_A,
	 KEY_S,
	 KEY_D,
